...
/**
 * @author wuxianxin
 * @version TikTokVideoListVO.java, v 0.1 2023年02月23日 Administrator Exp $
 */
public class TikTokVideoListVO extends BaseVO {

    private static final long serialVersionUID = 8902254498954632664L;
    ...
    public TikTokVideoListVO(String videoId, String title, String coverUrl, String playUrl) {
